...
`;
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is ITACHI_x_RAGE>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am ITACHI_x_RAGE whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "ITACHI_x_RAGE-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     } catch (_0x3537cb) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x53783b || !_0x53783b.toLowerCase().startsWith("http")) {
       return _0x272f8d.reply("*_Give me Video Link, " + prefix + "downmp4 https://telegra.ph/file/072fa6a932eab03639178.mp4_*");
     }
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "ITACHI_x_RAGE tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *ITACHI_x_RAGE • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({
   ...
   try {
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "ITACHI_x_RAGE--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("ITACHI_x_RAGE • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ITACHI_x_RAGE • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ITACHI_x_RAGE • APK DOWNLOAD LIST")) {
