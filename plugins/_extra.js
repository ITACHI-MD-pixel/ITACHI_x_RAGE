...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/ITACHI-MD-pixel/ITACHI_x_RAGE*");
    }
...
let tmpUrl = "https://telegra.ph/file/2c1f6c598eab67b0f8ffa.jpg";
const secmailData = {};
smd({
  pattern: "tempmail",
